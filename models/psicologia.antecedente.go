...
func GetPsicologiaAntecedenteById(id int) (v *PsicologiaAntecedente, err error) {
	o := orm.NewOrm()
	v = &PsicologiaAntecedente{IdAantecedente: IdAntecedente}
...
func GetAllPsicologiaAntecedente(query map[string]string, fields []string, sortby []string, order []string,
	offset int64, limit int64) (ml []interface{}, err error) {
		o := orm.NewOrm()
		qs := o.QueryTable(new(AntecedentePsicologico))
		for k, v := range query {
...
func UpdatePsicologiaAntecedenteById(m *PsicologiaAntecedente) (err error) {
	o := orm.NewOrm()
	v := PsicologiaAntecedente{IdAntecedente: m.IdAntecedente}
	if err = o.Read(&v); err == nil {
		var num int64
...
func DeletePsicologiaAntecedente(id int) (err error) {
	o := orm.NewOrm()
	v := PsicologiaAntecedente{IdAntecedente: id}
	// ascertain id exists in the database
	if err = o.Read(&v); err == nil {
		var num int64
		if num, err = o.Delete(&PsicologiaAntecedente{IdAntecedente: id}); err == nil {
